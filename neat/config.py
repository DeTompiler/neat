...
class Config:
    def __init__(self, **kwargs):
        ...
        self.weights_distance_coefficient = kwargs.get('weights_distance_coefficient', 0.5)
        ...
        self.survivors = kwargs.get('survivors', 0.25)
        ...
        self.toggle_conn_prob = kwargs.get('toggle_conn_prob', 0.03)
        self.shift_weight_prob = kwargs.get('shift_weight_prob', 0.72)
        self.random_weight_prob = kwargs.get('random_weight_prob', 0.08)
